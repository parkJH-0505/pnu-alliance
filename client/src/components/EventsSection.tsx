      ...
      <div className="relative z-10 p-6 lg:p-7">
        ...
        <div className="space-y-2 mb-4">
          {[
            ...
            { icon: Users, text: `${event.capacity}명` },
          ].map((item, i) => (
        ...
        {!isPast && (
          <div className="mb-4">
            <div className="w-full h-1 bg-gold/10 overflow-hidden">
              <div className="h-full bg-gold/60 transition-all duration-300" style={{ width: "47%" }} />
            </div>
            <p className="text-ivory/40 text-xs mt-1">47% 모집됨</p>
          </div>
        )}
