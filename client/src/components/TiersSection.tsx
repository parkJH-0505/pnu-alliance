...
const tiers = [
  ...
  },
  {
    ...
    color: "[background:linear-gradient(180deg,oklch(0.75_0.18_49.77_/_0.15),transparent)]",
  ...
  },
  {
    ...
    color: "[background:linear-gradient(135deg,oklch(0.75_0.18_49.77_/_0.2),oklch(0.4_0.1_15_/_0.1))]",
  ...
  },
  {
    ...
    color: "[background:linear-gradient(135deg,oklch(0.75_0.18_49.77_/_0.25),oklch(0.4_0.1_15_/_0.15))]",
...
function TierCard({ tier, index }: { tier: typeof tiers[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      {tier.special && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r [background:linear-gradient(90deg,oklch(0.75_0.18_49.77),oklch(0.8_0.2_50))] text-charcoal-deep text-[10px] tracking-[0.25em] uppercase z-10" style={{ fontFamily: "var(--font-body)", fontWeight: 500 }}>
          By Invitation
        </div>
      )}
