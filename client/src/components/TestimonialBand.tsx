...
const quotes = [
  { text: "사람이 깡통이다. 무조건 사람 먼저 모아라.", author: "이대한", company: "BAE Systems" },
  ...
  { text: "고생은 이제 저까지만 하고 후배들부터는 조금 편하게 했으면.", author: "이대한", company: "BAE Systems" },
  { text: "30대 중반 안에 인생 전체의 씨앗을 만들어야.", author: "이윤규", company: "변호사" },
  { text: "지금은 스카이가 롤모델이지만, 나중에는 후배님이 만든 게 롤모델이 되는 거예요.", author: "이대한", company: "BAE Systems" },
];
